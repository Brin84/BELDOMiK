/**
 * Новый знак белорусского рубля (BYN) — официальный символ Нацбанка.
 * Inline-SVG (вектор из E:\BYN_symbol.svg), fill=currentColor — наследует
 * цвет текста и масштабируется вместе с ним (размер в em).
 * aria-hidden: цифры несут смысл, знак — декоративная единица валюты.
 */
...
export function BynSymbol({ size = '1em', className }: BynSymbolProps) {
  return (
    <svg
      className={className}
      width={size}
