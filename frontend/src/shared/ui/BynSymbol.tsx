/**
 * Официальный знак белорусского рубля BYN (File:BYN_symbol.svg).
...
export function BynSymbol({ className = '' }: BynSymbolProps) {
  return (
    <svg
      className={`inline-block w-[0.9em] h-[0.9em] align-[-0.1em] shrink-0 ${className}`}
      viewBox="0 0 700 700"
      aria-hidden="true"
    >
      <g fill="currentColor" transform="translate(0,700) scale(0.1,-0.1)">
