export const API_ENDPOINTS = {
  ...
  agencies: {
    list: '/api/v1/agencies',
    me: '/api/v1/agencies/me',
    create: '/api/v1/agencies',
    detail: (id: number) => `/api/v1/agencies/${id}`,
    update: (id: number) => `/api/v1/agencies/${id}`,
    properties: (id: number) => `/api/v1/agencies/${id}/properties`,
    members: (id: number) => `/api/v1/agencies/${id}/members`,
    addMember: (id: number) => `/api/v1/agencies/${id}/members`,
    removeMember: (id: number, userId: number) => `/api/v1/agencies/${id}/members/${userId}`,
  },
  monetization: {
    promotions: '/api/v1/monetization/promotions',
    plans: '/api/v1/monetization/plans',
    promote: (propertyId: number) => `/api/v1/monetization/properties/${propertyId}/promote`,
    propertyPromotions: (id: number) => `/api/v1/monetization/properties/${id}/promotions`,
    confirmPayment: (id: number) => `/api/v1/monetization/payments/${id}/confirm`,
