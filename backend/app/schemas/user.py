...
class UserRead(UserBase):
    ...
    def model_validate(cls, obj: dict | object) -> "UserRead":
        ...
        # Avatar хранится в связанном UserProfile (avatar_url) и подтягивается
        # lazy-load'ом — все вызовы model_validate идут в активной сессии
        # (/auth/telegram, /auth/me, admin). Ложим поверх данных пользователя.
